...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GuestbookDefinition) DeepCopyInto(out *GuestbookDefinition) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GuestbookDefinition.
func (in *GuestbookDefinition) DeepCopy() *GuestbookDefinition {
	if in == nil {
		return nil
	}
	out := new(GuestbookDefinition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GuestbookSpec) DeepCopyInto(out *GuestbookSpec) {
	*out = *in
	out.GuestbookDefinition = in.GuestbookDefinition
	out.GuestbookDefinitionNotInlined = in.GuestbookDefinitionNotInlined
}
